...
import { Modal, StyleSheet, TouchableOpacity, View, Platform, KeyboardAvoidingView, TextInput } from 'react-native';
            ...
            >
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.header}>
                        <Text variant="l" weight="bold">Add Funds</Text>
                    ...
                    <View style={styles.amountContainer}>
                        ...
                        <View style={styles.inputSection}>
                            <Text variant="xl" weight="bold" color={colors.primary} style={styles.currencySymbol}>₹</Text>
                            <TextInput
                        ...
                        <TouchableOpacity onPress={handleIncrement} style={styles.actionBtn}>
                    ...
                    <View style={styles.quickSelect}>
                        {[500, 1000, 2000, 5000].map((val) => (
                            ...
                            >
                                <Text variant="s" weight="medium" color={amount === val ? colors.surface : colors.textSecondary}>
                                    ₹{val}
                                </Text>
                            </TouchableOpacity>
                        ))}
