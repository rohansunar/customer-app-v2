    ...
    >
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          <Text weight="bold" variant="s" color={address.isDefault ? colors.primary : colors.textPrimary}>
            {address.label}
            {address.isDefault && ' (Default)'}
          </Text>
        </View>
        <Text variant="xs" color={colors.textSecondary} numberOfLines={1} style={styles.address}>
          {address.address}
        </Text>
