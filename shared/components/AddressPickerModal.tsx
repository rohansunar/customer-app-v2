...
export function AddressPickerModal({ isVisible, onClose }: AddressPickerModalProps) {
                    ...
                    {!showForm ? (
                        <>
                            <View style={styles.header}>
                                <Text variant="l" weight="bold">Select Address</Text>
                            ...
                            >
                                ...
                                <Text color={colors.primary} weight="medium" style={styles.addButtonText}>
                                    Add Address
                                </Text>
                            </TouchableOpacity>
