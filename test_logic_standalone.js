...
function runTests() {
    ...
    testCases.forEach((test) => {
        ...
        // Compare YMD
        const startMatch = rStart.getFullYear() === test.expectedStart.getFullYear() &&
            rStart.getMonth() === test.expectedStart.getMonth() &&
            rStart.getDate() === test.expectedStart.getDate();

        const endMatch = rEnd.getFullYear() === test.expectedEnd.getFullYear() &&
        ...
        if (startMatch && endMatch && isNextMonthMatch) {
            ...
            console.log(`  Expected Start: ${test.expectedStart.toDateString()}, Got: ${rStart.toDateString()}`);
            console.log(`  Expected End:   ${test.expectedEnd.toDateString()}, Got: ${rEnd.toDateString()}`);
            console.log(`  Expected NextMonth: ${test.isNextMonth}, Got: ${result.isNextMonth}`);
            failed++;
        }
    });
